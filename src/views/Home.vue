<template>
  <div>
    <div class="content-wrapper kanban w-100" style="min-height: 543px;">
      <Header title="Kanban Petroeng"/>
      <Form v-if="form"/>
      <ContainerCards />
    </div>
  </div>
